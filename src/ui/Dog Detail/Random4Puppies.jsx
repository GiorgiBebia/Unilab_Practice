...
export function Random4Puppies({ item }) {
  return (
    <Link className="flex" to={`/dog/${item.name}`} onClick={scrollToTop}>
      <div className="w-[280px] mobile:w-[185px] h-[378px] mobile:h-[317px] bg-white rounded-[12px]">
        <img
          ...
          alt={item.name}
        />
        <h3 className="font-SFProDisplay font-bold text-[16px] mt-[8px] mobile:mt-[4px] mx-[16px] mobile:mx-[12px]">
          {item.name}
        </h3>
        <div className="flex gap-[4px] ml-[16px] mobile:ml-[12px] mt-[4px] items-center mobile:flex-col mobile:items-start">
